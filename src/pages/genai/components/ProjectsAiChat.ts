...
export class ProjectsAiChat extends BaseComponent {
  ...
  constructor(page: Page, container: Locator) {
    ...
    this.myMessage = this.container.locator('[class="sc-cxxOSt rbELc"]:nth-child(2)');
    this.messageField = this.container.locator('[placeholder="Send a message]');
    this.sendButton = this.container.locator('[placeholder="Send a message"] + button');
  }
